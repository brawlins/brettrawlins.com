...
Recently I heard about a cool face detection library called [face-api.js](https://github.com/justadudewhohacks/face-api.js/). I love the functionality that FamilySearch has on their website where you can label faces on a digital image, so I thought it would be fun to see if I could build something similar using this library to auto-detect the faces.

Here's the little app I came up with:

- Github: [https://github.com/brawlins/face-detection-app](https://github.com/brawlins/face-detection-app)
- Demo: [https://face-detection-app-xi.vercel.app](https://face-detection-app-xi.vercel.app)
...
Check it out here: [https://github.com/justadudewhohacks/face-api.js/](https://github.com/justadudewhohacks/face-api.js/)
