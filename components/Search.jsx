    ...
    <div ref={searchRef} className="relative">
      <div className="relative">
        <input
          ...
          className="w-64 px-4 py-2 pl-10 text-sm border border-gray-600 bg-gray-800 text-gray-200 placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
        <svg
        ...
        <div className="absolute top-full left-0 right-0 mt-2 bg-gray-800 border border-gray-600 rounded-lg shadow-xl z-50 max-h-96 overflow-y-auto">
          {results.length > 0 ? (
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mt-2 text-xs text-gray-400">
                        <span className="inline-block bg-gray-700 text-gray-300 px-2 py-0.5 rounded-full mr-2">
            ...
            <div className="px-4 py-6 text-center text-gray-400">
              <svg
                className="mx-auto w-6 h-6 mb-2 text-gray-500"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
